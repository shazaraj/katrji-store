        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <label class="modal-title text-text-bold-600" id="modelheading"> إضافة زبون  </label>
...
{{--                            <div class="col-md-12"> <label>  نوع الزبون </label>--}}
...
{{--                                </select>--}}
{{--                            </div>--}}
                            <div class="col-md-12"> <label> نوع التربية </label>
                                <div class="form-group">
                                    <input type="text" name="services_type" id="services_type" placeholder="" class="form-control">
                                </div>
                            </div>
        ...
        $(function () {
            ...
            var table = $('#tableData').DataTable({
                ...
                columns: [
                    ...
                    {data: 'services_type', name: 'services_type'},
