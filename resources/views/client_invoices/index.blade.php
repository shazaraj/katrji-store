            ...
            <div class="modal-content">
                ...
                <form method="post" id="productForm" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="text" id="client_id" class="form-control" disabled>
                        <br/>
                        <div  >
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var table = $('#tableData').DataTable({
                ...
                ajax: "{{ route('client_invoices.index')}}",
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $.get("{{ route('client.sale1') }}" + '/' + product_id + '/edit', function (data) {
                    item.html("<i class='fa fa-eye'></i>");
                    $('#modelheading').html("تفاصيل فاتورة");
                    $('#advertModal').modal('show');

                    $('#_id').val(data.invoice.id);
            ...
            $('#action').click(function (e) {
                ...
                $.ajax({
                    url:"{{url('print_invoices')}}/"+item_id,
                    method:"POST",
                    data:{
                        '_token':'{{csrf_token()}}',
                        'cart_id':item_id
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                $.ajax({
                    ...
                    url: "{{ route('client_invoices.store') }}" + '/' + product_id,
