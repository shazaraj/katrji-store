        ...
        <div class="sidebar-content main-menu-content">
            <div class="nav-container">
                <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    </li><li class=" nav-item"><a href="{{url('/report')}}"><i class="fa fa-line-chart"></i><span class="menu-title" data-i18n="Email"> التقارير </span></a>
    ...
    <div class="main-panel">
        ...
        <div class="main-content">
            ...
            <div class="content-wrapper">
                <div class="text-center"><u><h1 align="center">Dr. Hassn Katrji</h1></u></div>
                <div class="card 2"> <img class="avatar" align="center" src="{{asset('app-assets\img\ico\logo.png')}}" alt="avatar" width="400" height="400"></div>
